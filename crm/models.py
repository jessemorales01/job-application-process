...
class AutoDetectedApplication(models.Model):
    ...
    where_applied = models.CharField(max_length=100, blank=True, help_text="Job board or platform where application was submitted")
    applied_date = models.DateField(null=True, blank=True, help_text="Date when application was submitted (extracted from email)")
    email = models.EmailField(blank=True, help_text="Contact email if mentioned in email")
    phone_number = models.CharField(max_length=20, blank=True, help_text="Phone number if mentioned in email")
    salary_range = models.CharField(max_length=100, blank=True, help_text="Salary range if mentioned in email")
